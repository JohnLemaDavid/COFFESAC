...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      inputFormatters: widget.inputFormatter ?? (widget.inputType == TextInputType.phone ? <TextInputFormatter>[FilteringTextInputFormatter.allow(RegExp('[0-9+]'))] : null),
      decoration: widget.inputDecoration ?? InputDecoration(
        ...
        hintStyle: widget.hintStyle ?? robotoRegular.copyWith(
        ...
        focusedBorder: widget.borderColor == null ? null : OutlineInputBorder(
          borderSide: BorderSide(color: widget.borderColor!, width: 1),
        ),
        enabledBorder: widget.borderColor == null ? null : OutlineInputBorder(
          borderSide: BorderSide(color: widget.borderColor!, width: 1),
        ),
      ),

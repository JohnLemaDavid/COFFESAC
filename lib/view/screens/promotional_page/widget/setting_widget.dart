...
class _SettingWidgetState extends State<SettingWidget> {
  ...
  void initState() {
    ...
    if(splashController.getBranchId() < 1) {
      ...
      splashController.updateBranchId(splashController.getBranchId(),isUpdate: false);
    }
   TableModel? table =  splashController.getTable(splashController.getTableId(), branchId: splashController.getBranchId());
    ...
    if(table == null || splashController.getTableId() < 1) {
      ...
      splashController.updateTableId(splashController.getTableId(),isUpdate: false);
    ...
    return SingleChildScrollView(
      child: GetBuilder<SplashController>(
        builder: (splashController) {
          ...
          if(splashController.configModel != null && splashController.configModel!.branch != null){
            for(int i = 0; i < splashController.configModel!.branch!.length; i++){
              if(splashController.configModel!.branch![i].id == splashController.selectedBranchId){
                isAvailable = true;
              }

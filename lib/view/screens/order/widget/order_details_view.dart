      ...
      builder: (orderController) {
        ...
        return orderController.currentOrderDetails == null ? Center(child: CustomLoader(
          ...
          builder: (context) {
            ...
            List<Details> orderDetails = orderController.currentOrderDetails?.details ?? [];
            if(orderController.currentOrderDetails?.details != null) {
              for(Details orderDetails in orderDetails) {
                itemsPrice = itemsPrice + (orderDetails.price! * orderDetails.quantity!.toInt());
                discount = discount + (orderDetails.discountOnProduct! * orderDetails.quantity!.toInt());
                tax = (tax + (orderDetails.taxAmount! * orderDetails.quantity!.toInt()) ); //+ orderDetails.addonTaxAmount!);
              ...
              child: Column(children: [
                ...
                Expanded(child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      int a = 0;
                      if(orderController.currentOrderDetails?.details != null) {
                         details = orderController.currentOrderDetails!.details![index];
                      }

                      String addonsName = '';


                      Details? orderDetails = orderController.currentOrderDetails?.details?[index];
                      ...
                      if(ids.length == details.addOnPrices?.length &&
                        ...
                        for(int i = 0; i < ids.length; i++){
                          addOnsPrice = addOnsPrice + (details.addOnPrices![i] * details.addOnQtys![i]);
                        }
                      }
                      ...
                      if(orderDetails != null && orderDetails.variations != null && orderDetails.variations!.isNotEmpty) {
                      ...
                      }else if(orderDetails != null && orderDetails.oldVariations != null && orderDetails.oldVariations!.isNotEmpty) {
                        ...
                        children: [
                          ...
                          Row(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                            Expanded(flex: 3,child: Column(
                              ...
                              children: [
                                ...
                                Text(PriceConverter.convertPrice(details.productDetails!.price!),
                                  style: robotoRegular.copyWith(
                                ...
                                if(variationText != '')
                                  Text('${'variations'.tr}: $variationText', style: robotoRegular.copyWith(
                                  fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor,
                                )),
                            ...
                            Expanded(child: Padding(
                              ...
                              child: Text(
                                '${details.quantity}', textAlign: TextAlign.center,
                                style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.titleLarge!.color!),
                              ),
                            )),
                            ...
                            Expanded(flex: 2,child: Column(
                              ...
                              children: [
                                ...
                                ProductTypeView(productType: details.productDetails?.productType),
                              ],
                            )),
                          ...
                          Builder(
                              builder: (context) {
                                bool render = false;
                                if(orderController.currentOrderDetails?.details != null) {
                                  render = orderController.currentOrderDetails!.details!.isNotEmpty && orderController.currentOrderDetails!.details!.length == index +1;
                                }
                                ...
                                return render ? Column(
                                  ...
                                  children: [
                                    ...
                                    PriceWithType(type: 'items_price'.tr,amount: PriceConverter.convertPrice(itemsPrice),),
                                    ...
                                    PriceWithType(type: 'addons'.tr, amount :'+ ${PriceConverter.convertPrice(addOnsPrice)}'),
                                    PriceWithType(type:'total'.tr,amount : PriceConverter.convertPrice(total + addOnsPrice), isTotal: true),

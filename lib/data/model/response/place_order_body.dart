...
class PlaceOrderBody {
  ...
  PlaceOrderBody copyWith({String? paymentStatus, String? paymentMethod, String? token, double? previousDue,String? tipo,int? idParametroCortesia,String? codigoUsuario}) {
    ...
    if(idParametroCortesia != null){
      _idParametroCortesia = idParametroCortesia;
    }
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    _tipo = json['tipo'];
    _idParametroCortesia = json['idParametroCortesia'];
    _codigoUsuario = json['codigoUsuario'];
    _token = json['token'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['tipo'] = _tipo;
    data['idParametroCortesia'] = _idParametroCortesia;
    data['codigoUsuario'] = _codigoUsuario;
    data['token'] = _token;
  ...
  int? get idParametroCortesia => _idParametroCortesia;
